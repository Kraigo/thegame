...
export class PlayerControl {
    ...
    rotate() {
        const playerVector = new Vector(
            this.game.player.view.x - this.game.camera.x + this.game.player.view.width / 2,
            this.game.player.view.y - this.game.camera.y + this.game.player.view.width / 2
        );
        this.game.player.lookAngle = playerVector.angleTo(new Vector(
            this.game.mouse.x,
            this.game.mouse.y
        ));
    }
